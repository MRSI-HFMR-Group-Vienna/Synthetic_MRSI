...
def main_entry():
    ...
    if True:  # TODO change: use cache here:
        ...
        # block_size = (int(5), int(112/2), int(128/2), int(80/2)) # works with 100_000
        ...
        coil_sensitivity_maps = coil_sensitivity_maps_loader.interpolate(target_size=target_size, order=3, compute_on_device='cuda', gpu_index=0, return_on_device='cuda')
        ...
        sampling_model = SamplingModel(computational_graph_spectral_spatial_model=computational_graph,
                                       ...
                                       path_cache='/home/mschuster/projects/Synthetic_MRSI/cache/dask_tmp', # TODO: ha sno effect!
                                       persist_computational_graph_spectral_spatial_model=False
                                       )

        computational_graphs_list = sampling_model.apply_coil_sensitivity_maps(compute_on_device='cuda', # cuda work with 100_000
